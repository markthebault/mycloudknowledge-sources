module "alb" {
  ...
  target_groups            = "${list(map("name", "wordpress", "backend_protocol", "HTTP", "backend_port", "80", "health_check_matcher", "200-399", "slow_start", "200", "stickiness_enabled", "true", "cookie_duration", "3600"))}"
